...
exports.Version = exports.NeoxrApi = exports.Utils = exports.Exif = exports.Node = exports.Spam = exports.Scraper =
  exports.JID = exports.Instance = exports.Converter = exports.Cooldown = exports.Config = exports.Proxy = exports
  .Database = exports.Client = exports.Chiper = exports.CryptoKey = void 0;
...
const Config = node_fs_1.default.existsSync('./config.json') ? JSON.parse(node_fs_1.default.readFileSync(
  './config.json', 'utf-8')) : {};
